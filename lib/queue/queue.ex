defmodule TwitchIrc.Queue do
  ...
  defimpl Enumerable do
    ...
    def reduce(%TwitchIrc.Queue{internal_queue: internal_queue}, {:cont, acc}, fun) do
    ...
    def member?(%TwitchIrc.Queue{internal_queue: internal_queue}, element) do
      {:ok, :queue.member(element, internal_queue)}
    end

    def count(%TwitchIrc.Queue{length: length}) do
      {:ok, length}
    end

    def slice(%TwitchIrc.Queue{}) do
      {:error, __MODULE__}
    end
  end
